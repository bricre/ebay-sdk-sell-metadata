...
class NegotiatedPricePolicy extends AbstractModel
{
     ...
     * which best offers are automatically accepted. If set to <code>true</code>, the
     * category does support the setting of an automatic price for best-offers.
     *
     * @var bool
     */
     ...
     * auto-decline price for best offers. If set to <code>true</code>, the category
     * does support the setting of an automatic-decline price for best-offers.
     *
     * @var bool
     */
     ...
     * automatic counter-offer on best offers. If set to <code>true</code>, the
     * category does support the setting of an automatic counter-offer price for
     * best-offers.
     *
     * @var bool
     */
